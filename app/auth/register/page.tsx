...
export default function RegisterPage() {
  ...
  const handleRegister = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const { data: authData, error: authError } = await authService.signUp(email, password, name, role);
      ...
      if (authData.user) {
        toast({
          ...
          description: "Un email de confirmation a été envoyé. Vérifiez votre boîte email avant de vous connecter.",
        });
